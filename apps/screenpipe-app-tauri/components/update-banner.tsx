    ...
    try {
      ...
      if (os === "windows") {
        ...
        toast({
          ...
          description: "SHOGUN will restart automatically",
          duration: 10000,
        });
      }
    ...
    return (
      <div className={cn(
        ...
        <div className="flex items-center gap-2 flex-1">
          ...
          <span>
            SHOGUN <span className="font-medium">v{authRequired.version}</span> is available — sign in to download
          </span>
        </div>
    ...
    <div className={cn(
      ...
      <div className="flex items-center gap-2 flex-1">
        ...
        {isDownloading ? (
          ...
          <span>
            SHOGUN <span className="font-medium">v{updateInfo.version}</span> is ready
          </span>
        )}
      </div>
      {!isDownloading && (
